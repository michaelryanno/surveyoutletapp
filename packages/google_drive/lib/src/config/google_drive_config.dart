...
// const_clientId = "917756312218-hv0uf8gpu3632b9tcakbg2tvdp77ovne.apps.googleusercontent.com";
...
//   if not able to create id then it means user authetication has failed
  Future<String?> _getFolderId(ga.DriveApi driveApi) async {
    ...
    String folderName = "survey_outlet";
  ...
  Future uploadFileToGoogleDrive<bool>(File file) async {
    var res = false;
    var client = await getHttpClient();
    var drive = ga.DriveApi(client);
    String? folderId =  await _getFolderId(drive);
    print("**process to gdrive");
    print(folderId);
    if(folderId == null){
      print("Sign-in first Error");
    }else {
